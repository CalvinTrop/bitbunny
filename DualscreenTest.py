...
while True:
    ...
    image1 = Image.open("images/Bunz_Determined_128x64.bmp")
    ...
    image1 = Image.open("images/Bunz_Happy_128x64.bmp")
    oled1.image(image1)
    oled1.show()
    time.sleep(1)

    image1 = Image.open("images/Bunz_Sad_128x64.bmp")
    oled1.image(image1)
    oled1.show()
    time.sleep(1)

    image1 = Image.open("images/Bunz_Puzzled_128x64.bmp")
    oled1.image(image1)
    oled1.show()
    time.sleep(1)

    image1 = Image.open("images/Bunz_Sleepy_128x64.bmp")
    oled1.image(image1)
    oled1.show()
    time.sleep(1)

    image1 = Image.open("images/Bunz_Dead_128x64.bmp")
    oled1.image(image1)
    oled1.show()
    time.sleep(1)
